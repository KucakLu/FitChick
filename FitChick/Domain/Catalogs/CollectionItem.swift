...
struct CollectionData {
    static let items: [CollectionItem] = [
        ...
        CollectionItem(name: "birthday hat", rarity: .reguler, category: .head, svgAssetName: "birthday_hat", isOwned: true),
        CollectionItem(name: "set of magician", rarity: .rare, category: .body, svgAssetName: "set_of_magician", isOwned: true),
        CollectionItem(name: "burberry cap", rarity: .reguler, category: .head, svgAssetName: "burberry_cap", isOwned: true),
        CollectionItem(name: "black beret", rarity: .reguler, category: .head, svgAssetName: "red_beret", isOwned: true),
        CollectionItem(name: "reindeer hat", rarity: .reguler, category: .head, svgAssetName: "reindeer_hat", isOwned: true),
        CollectionItem(name: "artist hat", rarity: .reguler, category: .head, svgAssetName: "artist_hat", isOwned: true),
        CollectionItem(name: "vr glasses", rarity: .reguler, category: .face, svgAssetName: "vr_glasses", isOwned: true),
        CollectionItem(name: "police hat", rarity: .reguler, category: .head, svgAssetName: "police_hat", isOwned: true),
        CollectionItem(name: "tie", rarity: .reguler, category: .neck, svgAssetName: "tie", isOwned: true),
        CollectionItem(name: "witch hat", rarity: .reguler, category: .head, svgAssetName: "witch_hat", isOwned: true),
        CollectionItem(name: "christmas hat", rarity: .reguler, category: .head, svgAssetName: "christmas_hat", isOwned: true),
        CollectionItem(name: "sunglasses", rarity: .reguler, category: .face, svgAssetName: "sunglasses", isOwned: true),
        CollectionItem(name: "peter hat", rarity: .reguler, category: .head, svgAssetName: "peter_hat", isOwned: true),
        CollectionItem(name: "red scarf", rarity: .reguler, category: .neck, svgAssetName: "red_scarf", isOwned: true),
        CollectionItem(name: "circus hat", rarity: .reguler, category: .head, svgAssetName: "circus_hat", isOwned: true),
        CollectionItem(name: "softball cap", rarity: .reguler, category: .head, svgAssetName: "softball_cap", isOwned: true),
        CollectionItem(name: "necklace", rarity: .reguler, category: .neck, svgAssetName: "necklace", isOwned: true),
        CollectionItem(name: "ruby ", rarity: .reguler, category: .neck, svgAssetName: "ruby", isOwned: true),
        CollectionItem(name: "love necklace", rarity: .reguler, category: .neck, svgAssetName: "love_necklace", isOwned: true),
        CollectionItem(name: "diamond", rarity: .reguler, category: .neck, svgAssetName: "diamond", isOwned: true)
    ]
